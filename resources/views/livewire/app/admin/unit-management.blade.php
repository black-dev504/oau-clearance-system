...
<div class="flex flex-col gap-6">
    ...
    <div wire:click="setTable('units')"
        ...
        <div class="flex flex-col gap-2">
            ...
            <x-icons.unit-icon color="#8E51FF">
            ...
            @php $textColor = $activeTable === 'units' ? 'text-white' : 'text-black'; @endphp
                ...
                <p class="{{ $textColor }}">Clearance Units</p>
        </div>
        ...
        <div class="flex flex-col gap-2">
            <div class="flex gap-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg"
                 ...
                 <h1 class="font-black  {{ $textColor }} text-3xl">{{$officerCount}}</h1>
            </div>
            <p class=" {{ $textColor }}">Active Officers</p>
        </div>
    </div>
    ...
    <div class="flex w-full justify-between gap-4 ">
             ...
             <x-unit-management-card heading="Faculties" subheading="Top-level academic bodies" :count="$facultyCount" :currentTab="$activeTable">
                ...
                <x-icons.unit-icon :color="$activeTable === 'faculties'? '#8E51FF': '#6A7282' ">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M18.333 8.33337V13.3334" stroke="currentColor" stroke-width="1.66667" stroke-linecap="round"
                              stroke-linejoin="round"/>
                        <path
        ...
        @elseif($activeTable === 'faculties')
            <livewire:faculties-table />
        @elseif($activeTable === 'departments')
            <livewire:departments-table />
        @elseif($activeTable === 'hostels')
             <livewire:hostels-table />
        @endif
