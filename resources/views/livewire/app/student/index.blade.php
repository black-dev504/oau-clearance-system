...
<div class="dark:bg-zinc-800">
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 py-8">
        <div class="flex flex-col">
            <h1 class="text-2xl sm:text-4xl dark:text-zinc-100">Student Dashboard</h1>
            <p class="text-sm sm:text-base dark:text-zinc-400">Track your clearance progress and manage pending actions</p>
        </div>
    ...
    @if(!$registered)
        <div class=" flex flex-col gap-6 max-w-3xl mx-auto">
            ...
            <div
                class="  flex flex-col p-8 gap-6 bg-white dark:bg-zinc-600/20 dark:border-white/10 border border-primary-border rounded-[20px] text-center items-center">
                <x-icons.envelope/>

                <div class="flex flex-col gap-2">
                    <h1 class="text-3xl dark:text-zinc-100">Welcome to the Clearance Portal</h1>
                    <p class="text-[18px] dark:text-zinc-400">You haven't submitted a clearance request yet. Start your
                        clearance process to get approved by all university units.</p>
                </div>

                <flux:modal.trigger name="clearance-modal">
                    <button type="button"
                            class="inline-flex items-center cursor-pointer bg-linear-to-r text-center from-[#4B3BE4] to-[#A70088] text-white px-8 py-4.5 rounded-lg hover:bg-primary-700 transition-colors duration-200">
                        ...
                        <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path
                                    ...
                                    stroke="#4b3be4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M14 2V8H20" stroke="#4b3be4" strokeWidth="2" strokeLinecap="round"
                                      strokeLinejoin="round"/>
                                <path d="M16 13H8" stroke="#4b3be4" strokeWidth="2" strokeLinecap="round"
                                      strokeLinejoin="round"/>
                                <path d="M16 17H8" stroke="#4b3be4" strokeWidth="2" strokeLinecap="round"
                                      strokeLinejoin="round"/>
                            </svg>
                        </div>
                        <div class="flex-1">
                        ...
                        <div class="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path
                                    ...
                                    stroke="#a70088" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M22 4L12 14.01L9 11.01" stroke="#a70088" strokeWidth="2" strokeLinecap="round"
                                      strokeLinejoin="round"/>
                            </svg>
                        </div>
                        <div class="flex-1">
                            <h4 class="text-lg text-gray-900 mb-2 dark:text-zinc-100">Submit to All Units</h4>
                            <p class="text-gray-600 dark:text-zinc-400">Your clearance will be sent to Library, DSA,
                                Hostel, Senate, and other university units for review.</p>
                        </div>
                    </div>

                    <div class="flex gap-4">
                        <div
                            class="w-12 h-12 bg-green-100 dark:bg-zinc-600/20 rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path
                                    d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z"
                                    stroke="#027a48" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M12 6V12L16 14" stroke="#027a48" strokeWidth="2" strokeLinecap="round"
                                      strokeLinejoin="round"/>
                            </svg>
                        </div>
                        <div class="flex-1">
                            <h4 class="text-lg text-gray-900 mb-2 dark:text-zinc-100">Track Your Progress</h4>
                            <p class="text-gray-600 dark:text-zinc-400">Monitor approval status from each department,
                                view feedback, and take action on any rejected applications.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex gap-3">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" class="flex-shrink-0">
                        <path
                            d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z"
                            stroke="#4b3be4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M12 16V12" stroke="#4b3be4" strokeWidth="2" strokeLinecap="round"
                              strokeLinejoin="round"/>
                        <path d="M12 8H12.01" stroke="#4b3be4" strokeWidth="2" strokeLinecap="round"
                              strokeLinejoin="round"/>
                    </svg>
                    <div>
    ...
    @else
        ...
        <div class="mb-8">
            ...
            <div
                class="bg-white dark:bg-zinc-600/20 border dark:border-white/10 border-gray-200 rounded-xl overflow-hidden">
                <div
                    class="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-200 dark:divide-white/10">
                    <div class="p-6">
                    ...
                    <div class="p-6">
                        <h3 class="text-lg text-gray-900 dark:text-zinc-100 mb-4 flex items-center gap-2">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <path
                                    d="M12 0H4C2.01 0 2 0.9 2 2L2 18C2 19.1 2.89 20 3.99 20H16C17.1 20 18 19.1 18 18V6L12 0ZM4 18V2H11V7H16V18H4Z"
                                    fill="#4b3be4"/>
                            </svg>
                            Uploaded Documents
                        </h3>
                        <div class="space-y-3">
                            <div
                                class="flex items-center justify-between p-3 bg-gray-50 dark:bg-zinc-700/40 rounded-lg">
                            ...
                            <div
                                class="flex items-center justify-between p-3  dark:bg-zinc-700/40 bg-gray-50 rounded-lg">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 bg-blue-100 rounded flex items-center justify-center">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                                            <path
                ...
                <div
                    class="border-t border-gray-200 p-4 dark:bg-zinc-600/20 dark:border-white/10 bg-gray-50 flex items-center justify-between">
