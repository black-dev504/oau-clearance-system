<div class="">
    <div class="p-6.5 w-full grid grid-cols-2 rounded-[14px] shadow-xs bg-white border border-[#E0DCD4]">
    ...
    <div class="flex flex-col gap-2 p-6 mt-8 rounded-[14px] border border-[#FEE685] bg-white">
       ...
       <div class="border-t border-[#E0DCD4] mt-1 flex justify-between pt-4">
           ...
           <div class="flex-1 min-w-0 grid grid-cols-4 gap-6">
               <div>
                   <div class="flex items-center gap-1 ">
                       <div class="font-medium text-[#2D2D2D] text-sm">John Doe</div>
                   </div>
                   <div class="text-[12px] text-[#666666]">CSC/2000/1002</div>
               </div>
           ...
           <div class="justify-end">
               <div class="flex items-center gap-1 ">
                   <div class="font-medium text-[#2D2D2D] text-sm">April 25, 2026</div>
               </div>
               <div class="text-[12px] text-[#666666]">7:30am</div>
           </div>
    </div>
    </div>
