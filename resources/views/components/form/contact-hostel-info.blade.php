<div class=" ">
    ...
    <div class="bg-gray-50 rounded-xl p-6 space-y-6">
        ...
        <div class="w-full grid md:grid-cols-2 grid-cols-1 gap-4 border border-gray-200 shadow-sm dark:border-white/10 rounded-xl p-4 mt-4">
            <div class="col-span-2">
                <flux:input label="Contact address*" placeholder="1st ave"  />
            </div>
            <flux:input label="Email Address" placeholder="johndoe@gmail.com" type="email"  />
            <flux:input label="Phone Number" type="number" placeholder="234 0000 0000"  />
        </div>
    ...
    <div class="bg-gray-50 rounded-xl p-6 space-y-6 mt-6 ">
        ...
        <h4 class="text-lg font-medium text-gray-900 flex items-center gap-2">
                ...
                <flux:input label="Hall of Residence*" placeholder="Awo Hall"  />
                <flux:input label="Block*" placeholder="F" type="text"  />
                <flux:input label="Room Number" type="number" placeholder="303"  />
                <flux:input label="Bedspace" placeholder="corner 2"  />
