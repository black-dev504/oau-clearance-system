...
<flux:modal name="student-contact"   class="min-w-2xl rounded-2xl !p-0">
    ...
    <div class="w-full  rounded-t-2xl p-6 flex bg-gradient-to-r from-[#2D2855] to-secondary">
        <div class="flex gap-3 items-center" >
            ...
            <div class="flex flex-col">
                <h1 class="font-semibold text-[20px] dark:text-zinc-100 text-white">Contact Information</h1>
                <p class="text-[14px] dark:text-zinc-400 text-white/70">{{$this->selectedRequest?->name}}</p>
            </div>
        </div>
    </div>
    <div class="bg-white dark:bg-zinc-800 p-6 gap-4 flex w-full">
        <div class="w-full flex flex-col gap-4">
            ...
            <div class="w-full ">
                <label class="inline-flex items-center gap-2 text-sm font-medium text-gray-700 mb-1 dark:text-zinc-100">
            ...
            <div class="w-full">
                <label class="inline-flex dark:text-zinc-100 items-center gap-2 text-sm font-medium text-gray-700 mb-1">
